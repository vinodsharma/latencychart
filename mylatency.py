...
def parse_args():
    ...
    parser.add_argument("-d", "--discription", default=None,
            help="Service Configuration Description")
    parser.add_argument("-n", "--nr-workers", default=None,
            help="Number of workers used for this test")
...
if __name__ == '__main__':
    ...
    final_data = (args.discription,args.nr_workers,latencies_by_url)
